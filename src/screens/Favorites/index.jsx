...
const Favorites = ({ token, atual, audio, setAtual, setAudio }) => {
	...
	useFocusEffect(
		// Usando uma ferramenta do react navigation para visualizar o focus na tela
		React.useCallback(() => {
			// Funcao de callBack das chamadas nas mudanças de component/pagina do react para que seja executada uma vez apenas
			ListFavorites();
		}, []),
	);
			...
			<Container>
				<ContainerBody>
					<ContainerPlaylistData>
						...
						<ParagraphCenter>
							Personalize seu gosto
							musical do seu jeito!
						</ParagraphCenter>
					</ContainerPlaylistData>
